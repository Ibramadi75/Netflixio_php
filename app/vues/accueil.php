...
<style>
    ...
    .formulaire_container form label {
      position: absolute;
      left: 20px;
      top: 1em;
    ...
    .formulaire_container form input[type="text"],
    .formulaire_container form input[type="password"] {
      font-size: 20px;
      color: #8c8c8c;
      background: none;
      width: 100%;
    ...
    .formulaire_container form input[type="submit"] {
